...
![](./figures/ReLTER_site.png){.cover height="300"}

The manual of `ReLTER` package is found
...
Report bugs on the ROpenSci github [issues](https://github.com/ropensci/ReLTER/issues) page


![](./figures/ReLTER_issues.png){.cover height="300"}
...
Whenever reporting an issue or new feature request:
  ...
  - Use the [`reprex`](https://reprex.tidyverse.org/) package for this
...
```{r relter-site_map, warning=FALSE, message=FALSE, results='hide'}
tmap::tmap_mode("plot")
...
#### Additional examples are found in the `ReLTER` [documentation](https://docs.ropensci.org/ReLTER/articles/)
