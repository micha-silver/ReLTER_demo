...
## Acquiring third parties biodiversity data
...
```{r GOF, warning=FALSE, message=FALSE}
...
<iframe src="./other/occurrences_GOV.html" height="405" width="720" style="border: 1px solid #464646;"></iframe>

----

#### Second example, the Saldur River Catchment

```{r Saldur, warning=FALSE, message=FALSE}
...
<iframe src="./other/occurrences_saldur.html" height="405" width="720" style="border: 1px solid #464646;"></iframe>
