...
#### Transform this data into eLTER data template

Fields mapping between the three data source schemas (i.e., GBIF, iNaturalist, OBIS)
(following Peterseil et al., 2021) allowed to design `ReLTER` functions: `map_occ_gbif2elter` and `save_occ_eLTER_reporting_Archive`.

The example below gets iNaturalist data, for the Saldur River Catchment site.
...
This prepares an eLTER usable archive as:
