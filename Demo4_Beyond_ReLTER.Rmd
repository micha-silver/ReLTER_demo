...
```
```{r beyond-load-packages, message=FALSE, warning=FALSE, include=FALSE}
...
## Getting help with `R`
  ...
  - Package specific questions:
    * Approach the package maintainer
    * Report issues on package github repository
  - The [r] tagged questions on [gis.stackexchange.com](https://gis.stackexchange.com/questions/tagged/r) 
  - Maillists: [list of active maillists](https://www.r-project.org/mail.html)
    * R programming
    * R-SIG-Geo for spatial questions
...
**Please collaborate with `ReLTER` and/or contribute to the code (https://github.com/ropensci/ReLTER)**
